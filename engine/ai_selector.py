...
REGIME_STRATEGIES = {
    "TRENDING_UP":   ["MACD_MOMENTUM", "EMA_CROSS", "SUPERTREND", "SMC_SCALP"],  # MACD best for CE
    "TRENDING_DOWN": ["EMA_CROSS", "MACD_MOMENTUM", "SUPERTREND", "RSI_REVERSAL"],  # EMA_CROSS best for PE
